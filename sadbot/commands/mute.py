...
class MuteBotCommand(CommandInterface):
    ...
    def get_reply(self, message: Optional[Message] = None) -> Optional[List[BotAction]]:
        ...
        until_date = 3600
        return [BotAction(BOT_ACTION_TYPE_RESTRICT_CHAT_MEMBER, reply_ban_user_id=message.reply_id, reply_permissions=permissions, reply_restrict_until_date=until_date)]
