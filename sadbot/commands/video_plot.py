"""Function video plot bot command"""
...
class VideoPlotBotCommand(CommandInterface):
    """This is the video plot bot command class"""
    ...
    def command_regex(self) -> str:
        """Returns the regex for matching function video plot commands"""
        return r"((!|\.)([Vv][Ii][Dd][Ee][Oo][Pp][Ll][Oo][Tt])([3][Dd])?)\s.*"
